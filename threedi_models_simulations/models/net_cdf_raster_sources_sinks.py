...
class NetCDFRasterSourcesSinks(BaseModel):
    """
    ...
    def units_validate_enum(cls, value):
        ...
        if value not in set(["m/s", "mm", "mm/h", "mm/hr"]):
            raise ValueError(
                "must be one of enum values ('m/s', 'mm', 'mm/h', 'mm/hr')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetCDFRasterSourcesSinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetCDFRasterSourcesSinks from a dict"""
        if obj is None:
            return None
