...
class UpdateRevision(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commit_message", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateRevision from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateRevision from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"commit_message": obj.get("commit_message"), "tags": obj.get("tags")}
        )
        return _obj
