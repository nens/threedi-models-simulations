...
class TimeseriesLateral(BaseModel):
    """
    TimeseriesLateral
    """  # noqa: E501
    ...
    units: StrictStr = Field(description="'m3/s' (only option for now)")
    point: Optional[Point] = None
    connection_node: Optional[
    ...
    def units_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["m3/s"]):
            raise ValueError("must be one of enum values ('m3/s')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimeseriesLateral from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if connection_node (nullable) is None
        # and model_fields_set contains the field
        if self.connection_node is None and "connection_node" in self.model_fields_set:
            _dict["connection_node"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimeseriesLateral from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "connection_node": obj.get("connection_node"),
                "state": obj.get("state"),
