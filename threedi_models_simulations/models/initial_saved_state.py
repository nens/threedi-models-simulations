...
class InitialSavedState(BaseModel):
    """
    InitialSavedState
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitialSavedState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitialSavedState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "saved_state": obj.get("saved_state"),
                "id": obj.get("id"),
                "uuid": obj.get("uuid"),
            }
        )
