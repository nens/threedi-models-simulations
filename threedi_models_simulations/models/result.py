...
class Result(BaseModel):
    ...
    basic: StrictBool
    damage_estimation: StrictBool
    arrival_time: StrictBool
    __properties: ClassVar[List[str]] = ["basic", "damage_estimation", "arrival_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "basic": obj.get("basic"),
                "damage_estimation": obj.get("damage_estimation"),
