...
class Extent1(BaseModel):
    """
    Extent specified either in geojson, wkt or ewkt. Coordinates in longitude, latitude order.
    """  # noqa: E501

    type: StrictStr = Field(description="Type should always be 'Linestring'")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Extent1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Extent1 from a dict"""
        if obj is None:
            return None
