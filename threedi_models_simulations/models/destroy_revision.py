...
class DestroyRevision(BaseModel):
    """
    DestroyRevision
    """  # noqa: E501

    number: StrictInt = Field(description="Provide revision number as verification")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DestroyRevision from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DestroyRevision from a dict"""
        if obj is None:
            return None
