...
class Polygon(BaseModel):
    """
    Polygon specified in wkt or geojson, interior rings are not allowed. Coordinates in longitude, latitude order.
    """  # noqa: E501

    type: StrictStr = Field(description="Type should always be 'Polygon'")
