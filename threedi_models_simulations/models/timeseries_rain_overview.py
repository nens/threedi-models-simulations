...
class TimeseriesRainOverview(BaseModel):
    """
    ...
    units: StrictStr = Field(description="m/s is only option for now")
    ...
    def units_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["m/s"]):
            raise ValueError("must be one of enum values ('m/s')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimeseriesRainOverview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimeseriesRainOverview from a dict"""
        if obj is None:
            return None
