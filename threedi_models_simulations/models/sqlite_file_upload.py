...
class SqliteFileUpload(BaseModel):
    """
    SqliteFileUpload
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["put_url", "filename", "status", "md5sum"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SqliteFileUpload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SqliteFileUpload from a dict"""
        if obj is None:
            return None
