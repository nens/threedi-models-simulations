...
class BaseEventState(BaseModel):
    """
    BaseEventState
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["state", "state_detail"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BaseEventState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BaseEventState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"state": obj.get("state"), "state_detail": obj.get("state_detail")}
        )
        return _obj
