...
class CurrentVersion(BaseModel):
    ...
    threedi_version: Optional[StrictStr] = None
    threedicore_version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["threedi_version", "threedicore_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrentVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CurrentVersion from a dict"""
        if obj is None:
            return None
