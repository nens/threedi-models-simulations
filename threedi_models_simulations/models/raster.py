...
class Raster(BaseModel):
    ...
    geotransform: Optional[
        Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=6)]
    ] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('dem_file', 'dem_raw_file', 'equilibrium_infiltration_rate_file', 'frict_coef_file', 'initial_groundwater_level_file', 'initial_waterlevel_file', 'groundwater_hydro_connectivity_file', 'groundwater_impervious_layer_level_file', 'infiltration_decay_period_file', 'initial_infiltration_rate_file', 'leakage_file', 'phreatic_storage_capacity_file', 'hydraulic_conductivity_file', 'porosity_file', 'infiltration_rate_file', 'max_infiltration_capacity_file', 'interception_file', 'vegetation_height_file', 'vegetation_drag_coefficient_file', 'vegetation_stem_count_file', 'vegetation_stem_diameter_file', 'initial_concentration_file', 'initial_groundwater_concentration_file')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Raster from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if threedimodel (nullable) is None
        # and model_fields_set contains the field
        if self.threedimodel is None and "threedimodel" in self.model_fields_set:
            _dict["threedimodel"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Raster from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "extent": Extent.from_dict(obj["extent"])
