...
class UploadWithSubstances(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["substances", "put_url", "filename", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadWithSubstances from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadWithSubstances from a dict"""
        if obj is None:
            return None
