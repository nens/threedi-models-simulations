...
class Point(BaseModel):
    """
    Point specified in wkt or geojson. Coordinates in longitude, latitude order.
    """  # noqa: E501

    type: StrictStr = Field(description="Type should always be 'Point'")
    coordinates: Annotated[
        List[Union[StrictFloat, StrictInt]], Field(min_length=2, max_length=2)
    ] = Field(description="List of exactly one coordinate (longitude, latitude order)")
