...
class GridEventState(BaseModel):
    """
    GridEventState
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["state", "state_detail", "grid_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GridEventState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GridEventState from a dict"""
        if obj is None:
            return None
