...
class Linestring(BaseModel):
    """
    Linestring (epsg:4326) specified in wkt or geojson. Coordinates in longitude, latitude order.
    """  # noqa: E501
    ...
    coordinates: Annotated[
        ...
        Field(min_length=2),
    ] = Field(description="List of coordinates. (longitude, latitude order)")
