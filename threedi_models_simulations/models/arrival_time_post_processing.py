...
class ArrivalTimePostProcessing(BaseModel):
    """
    ArrivalTimePostProcessing
    """  # noqa: E501

    basic_post_processing: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["basic_post_processing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArrivalTimePostProcessing from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArrivalTimePostProcessing from a dict"""
        if obj is None:
            return None
