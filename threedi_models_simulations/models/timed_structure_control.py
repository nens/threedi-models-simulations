...
class TimedStructureControl(BaseModel):
    """
    ...
    duration: Annotated[int, Field(strict=True, ge=1)]
    value: Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=2)]
    type: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimedStructureControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimedStructureControl from a dict"""
        if obj is None:
            return None
