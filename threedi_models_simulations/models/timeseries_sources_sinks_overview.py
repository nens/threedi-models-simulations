...
class TimeseriesSourcesSinksOverview(BaseModel):
    """
    ...
    units: StrictStr = Field(description="'m/s' (only option for now)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimeseriesSourcesSinksOverview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimeseriesSourcesSinksOverview from a dict"""
        if obj is None:
            return None
